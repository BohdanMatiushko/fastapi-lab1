# Практична робота №5
## Розробка RESTful API з автентифікацією за допомогою FastAPI
...
Розробити RESTful API на основі фреймворку **FastAPI** з використанням асинхронного ORM **SQLAlchemy**, бази даних **PostgreSQL**, системи міграцій **Alembic**, автентифікації через **JWT**, та контейнеризації за допомогою **Docker Compose**.
